...
- [ ] **Actuele beoordeling en aantal reviews doorgeven** — Bijv. "4,8 sterren, 32 reviews", zodat dit correct getoond kan worden op de site (structured data en/of testimonials-sectie).
